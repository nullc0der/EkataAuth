...
LISTMONK_SERVER_URL = get_env_var("LISTMONK_SERVER_URL")
LISTMONK_API_USERNAME = get_env_var("LISTMONK_API_USERNAME")
LISTMONK_API_PASSWORD = get_env_var("LISTMONK_API_PASSWORD")
LISTMONK_SUBSCRIBERS_LIST = list(map(lambda x: int(x), get_env_var(
    "LISTMONK_SUBSCRIBERS_LIST").split(",")))
